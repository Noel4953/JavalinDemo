...
public class HelloJavalin {
	...
	app.get("/hello", ctx->{ctx.result("Hello Again ahahahahah ! ! ! !");});
	
	app.get("/hello/{name}", ctx->{ctx.result("Hello Again ahahahahah ! ! ! !"+ ctx.pathParam("name"));});
	...
	app.get("/hello/{fname}/{lname}", ctx->{ctx.result("Hello Again ahahahahah ! ! ! ! "+
	ctx.pathParam("fname")+
	ctx.pathParam("lname"));});
